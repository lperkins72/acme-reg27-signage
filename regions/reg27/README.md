...
This folder is the region-default content layer for `reg27`.
...
- `regions/reg27/data/primary-assets.json`
- `regions/reg27/data/primary.json`
- `regions/reg27/data/footer.json`
- `regions/reg27/data/primaryending.json`
- `regions/reg27/assets/primary/manifest.json`
- `regions/reg27/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg27`.
